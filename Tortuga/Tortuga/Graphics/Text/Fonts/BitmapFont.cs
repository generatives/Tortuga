...
namespace Cyotek.Drawing.BitmapFont
{
    ...
    public class BitmapFont : IEnumerable<Character>
    {
        ...
        public const string DefaultFontName = "default_font.fnt";
        ...
        /// </value>
        public Vector2i Spacing { get; set; }
                    ...
                    if (parts.Length != 0)
                    {
                        switch (parts[0])
                        {
                            case "info":
                                ...
                                this.Spacing = BitmapFontLoader.ParseVector2i(BitmapFontLoader.GetNamedString(parts, "spacing"));
        ...
        public virtual void LoadXml(TextReader reader)
        {
            ...
            this.Spacing = BitmapFontLoader.ParseVector2i(properties.Attributes["spacing"].Value);
